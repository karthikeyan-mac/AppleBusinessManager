...
# Script: List_Organization_Devices_ASM.py
# Karthikeyan Marappan
#
# Purpose
#
# Query Apple School Manager (ASM) to get a list of devices in an organization that enroll using Automated Device Enrollment. (https://developer.apple.com/documentation/appleschoolmanagerapi/get-org-devices)
#
...
#
#Replace the placeholder values below (`Certificate.pem`, client_id, device_ids_file etc.) with your own ASM credentials. (https://support.apple.com/en-ca/guide/apple-school-manager/axm33189f66a/1/web/1)
#
